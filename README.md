...
*NOTE: This is the original MongoHQ version of this buildpack, which won't work for new users.*
...
2. Set this repository as the buildpack URL:
        ...
        heroku config:set BUILDPACK_URL=https://github.com/AdmitHub/meteor-buildpack-horse.git#mongohq
